                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form method="POST" action="<?php echo URLROOT ?>/ProfessorController/addProfessor" class="mx-1 mx-md-4">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <label class="form-label" for="form3Example3c">Genre</label>
                                                <input type="text" id="form3Example3c" class="form-control" name="genre" />
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <label class="form-label" for="form3Example3c">Matricule</label>
                                                <input type="text" id="form3Example3c" class="form-control" name="matricule" />
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="text" id="form3Example3c" class="form-control" name="class" />
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <label class="form-label" for="form3Example3c">matiere</label>
                                                <input type="text" id="form3Example3c" class="form-control" name="matiere" />
